...
namespace Tests\Locastic\SyliusStoreLocatorPlugin\Behat\Context\Ui\Shop\Checkout;

use Behat\Behat\Context\Context;
use Sylius\Behat\Page\Shop\Checkout\CompletePageInterface;
use Sylius\Behat\Page\Shop\Checkout\SelectPaymentPageInterface;
use Tests\Locastic\SyliusStoreLocatorPlugin\Behat\Page\Shop\Checkout\SelectShippingPageInterface;
...
final class CheckoutShippingContext implements Context
{
     ...
     */
    public function iShouldSeeStoreLocation($storeName)
    {
        Assert::true($this->selectShippingPage->hasStoreSelector($storeName));
    }
    ...
    {
        $this->selectShippingPage->selectStore($storeName);
    }

    /**
     * @Then /^I should see selected  "([^"]*)" store location$/
     */
    public function iShouldSeeSelectedStoreLocation($storeName)
    {
        Assert::same($this->selectShippingPage->getSelectedStoreName(), $storeName);
    }
